...
export const UserLayout = ({children}:LayoutProps) => {
    ...
    return (
        <div className={`g-sidenav-show bg-gray-200 ${nav ? 'g-sidenav-pinned': ''} h-100`}>
            ...
            <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
                <div className="container-fluid py-1 px-3">
                    ...
                    <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li className="breadcrumb-item text-sm text-dark active" aria-current="page">{window.location.pathname}</li>
                    </ol>
                    ...
                    <ul className="navbar-nav  justify-content-end">
                        ...
                        <a onClick={()=>setNav((prev)=>!prev)}className="nav-link text-body p-0" id="iconNavbarSidenav">
